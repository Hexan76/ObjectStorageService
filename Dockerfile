...
RUN git clone https://oauth2:glpat-1KBqEKkCtTeP2sdZFcjYX286MQp1OjFzCA.01.0y053mgm3@gitlab.bsla.dev/microservice/dotnet/building-block.git ../building-block
